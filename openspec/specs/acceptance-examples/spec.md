...
Specify YAML acceptance examples that demonstrate useful instruments and effects built from primitives, composites, scripts, presets, and explicit graph routing.
