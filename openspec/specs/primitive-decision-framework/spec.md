...
Specify the classification framework for deciding whether engine behaviour belongs in Rust primitives, YAML composites, scripts, presets, or future tooling.
