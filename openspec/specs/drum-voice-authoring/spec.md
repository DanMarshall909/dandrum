...
Specify how Dandrum authors initial 808/909-style drum voices: composed from
reusable synthesis primitives first, seeded from free/open reference instruments
as tuning hints (never copied assets), and refined later through an offline
spectral/envelope comparison workflow.
