...
The graph processor SHALL dispatch modules in topological order respecting delay-boundary cycle cuts, so every module's
inputs are computed before it runs.
