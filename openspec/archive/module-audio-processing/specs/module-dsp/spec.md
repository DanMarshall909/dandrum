...
The oscillator module SHALL generate a sawtooth waveform at the pitch extracted from the most recent MIDI note-on event,
starting when a gate event is received.
