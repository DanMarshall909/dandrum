...
- [x] 6.1 Add a minimal YAML example defining and instantiating a composite `drum_voice` subsystem.
- [x] 6.2 Add a YAML example showing a composite exposes custom public inputs while hiding its internal modules.
- [x] 6.3 Document through tests or comments that composites are YAML-defined subsystems, not Rust built-ins.
