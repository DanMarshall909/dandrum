...
- [ ] 2.1 Introduce typed `BufferId`, `EventQueueId`, `CompiledEdge`, `RenderStep`, and `RenderPlan` structures.
...
- [ ] 3.1 Add a prepared audio/control arena sized by maximum block size, compiled buffer count, and maximum voice count.
- [ ] 3.2 Add APIs for clearing accumulation buffers, summing compiled edges, filling default control buffers, and borrowing short-lived input/output slices.
