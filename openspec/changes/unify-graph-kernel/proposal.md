...
- **Module library** ($LIB/$USER_LIB packaging): module packages describe graph definitions with static parameters; discovery metadata format changes.
