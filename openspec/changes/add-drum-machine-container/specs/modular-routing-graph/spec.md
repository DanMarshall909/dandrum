...
The graph validator SHALL treat drum-machine public ports as named typed event ports derived from the module's standard event input and declared pads.
...
- **THEN** the expanded graph SHALL contain event-compatible routes for pad triggers and no implicit audio, control, sampler, or mixer routes
...
- **WHEN** a drum-machine module participates in a feedback cycle without an explicit delay or future scheduling boundary
